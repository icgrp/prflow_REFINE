...
set operator "dataredir" # to be changed
set benchmark "rendering" # to be changed
set pblock_name "p_dummy" # to be changed
set part xcu50-fsvh2104-2-e # to be changed
