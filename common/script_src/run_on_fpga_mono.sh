...
if [ ! -f ./input_src/BENCHMARK/__mono_done__ ]; then
    ...
    sleep 50
    ssh -i ~/.ssh/id_rsa_zcu102 root@10.10.7.1 "cd /run/media/mmcblk0p1/; rm -rf __static_loaded__; ./run_app.sh; ./run_app.sh; ./run_app.sh > results.txt; scp -i ~/.ssh/id_rsa results.txt summary.csv dopark@10.10.7.2:/home/dopark/workspace/zcu102_tuning/prflow_DSE_bi_22.1/_bi_results/BENCHMARK/"
