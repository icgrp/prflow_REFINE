...
module rasterization2_m_rasterization2_even_Pipeline_VITIS_LOOP_213_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [7:0] fragment_y_V_1_load_reg_217;
reg   [15:0] j_fu_54;
wire   [15:0] add_ln213_fu_144_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        fragment_y_V_1_load_reg_217 <= fragment_y_V_1_q0;
        tmp_reg_232 <= fragment_y_V_1_q0[32'd7];
    end
end
...
assign Output_3_TDATA = zext_ln414_fu_183_p1;

assign Output_4_TDATA = zext_ln414_fu_183_p1;

assign add_ln213_fu_144_p2 = (ap_sig_allocacmp_j_2 + 16'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter2 == 1'b1) & (((tmp_reg_232 == 1'd1) & (1'b0 == Output_3_TREADY)) | ((tmp_reg_232 == 1'd0) & (1'b0 == Output_4_TREADY))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state3_io) | ((tmp_reg_232 == 1'd1) & (1'b0 == Output_3_TREADY)) | ((tmp_reg_232 == 1'd0) & (1'b0 == Output_4_TREADY))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state3_io) | ((tmp_reg_232 == 1'd1) & (1'b0 == Output_3_TREADY)) | ((tmp_reg_232 == 1'd0) & (1'b0 == Output_4_TREADY))));
end
...
always @ (*) begin
    ap_block_state3_io = (((tmp_reg_232 == 1'd1) & (1'b0 == Output_3_TREADY)) | ((tmp_reg_232 == 1'd0) & (1'b0 == Output_4_TREADY)));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = (((tmp_reg_232 == 1'd1) & (1'b0 == Output_3_TREADY)) | ((tmp_reg_232 == 1'd0) & (1'b0 == Output_4_TREADY)));
end
...
assign fragment_color_V_1_address0 = zext_ln1073_reg_200;

assign fragment_x_V_1_address0 = zext_ln1073_reg_200;

assign fragment_y_V_1_address0 = zext_ln1073_fu_150_p1;

assign fragment_z_V_1_address0 = zext_ln1073_reg_200;

assign icmp_ln1073_fu_138_p2 = ((ap_sig_allocacmp_j_2 == i_V_reload) ? 1'b1 : 1'b0);

assign out_tmp_V_fu_168_p5 = {{{{fragment_color_V_1_q0}, {fragment_z_V_1_q0}}, {fragment_y_V_1_load_reg_217}}, {fragment_x_V_1_q0}};

assign sext_ln414_fu_179_p1 = $signed(out_tmp_V_fu_168_p5);

assign zext_ln1073_fu_150_p1 = ap_sig_allocacmp_j_2;
...
endmodule //rasterization2_m_rasterization2_even_Pipeline_VITIS_LOOP_213_1
