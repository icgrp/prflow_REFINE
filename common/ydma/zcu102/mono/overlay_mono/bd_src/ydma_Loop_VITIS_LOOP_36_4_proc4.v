...
reg   [31:0] output_size_read_reg_125;
reg   [57:0] trunc_ln_reg_131;
wire   [30:0] trunc_ln29_fu_95_p1;
reg   [30:0] trunc_ln29_reg_137;
wire   [30:0] select_ln36_fu_104_p3;
reg   [30:0] select_ln36_reg_142;
...
wire  signed [63:0] sext_ln36_fu_111_p1;
wire   [31:0] zext_ln36_fu_121_p1;
reg    ap_block_state1;
wire   [0:0] icmp_ln36_fu_99_p2;
reg   [72:0] ap_NS_fsm;
...
ydma_Loop_VITIS_LOOP_36_4_proc4_Pipeline_VITIS_LOOP_36_4 grp_Loop_VITIS_LOOP_36_4_proc4_Pipeline_VITIS_LOOP_36_4_fu_75(
    ...
    .sext_ln36(trunc_ln_reg_131),
    .output_size_load(output_size_read_reg_125),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state73) & (m_axi_aximm2_BVALID == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        output_size_read_reg_125 <= output_size_dout;
        trunc_ln29_reg_137 <= trunc_ln29_fu_95_p1;
        trunc_ln_reg_131 <= {{output2_dout[63:6]}};
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        select_ln36_reg_142 <= select_ln36_fu_104_p3;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state73) & (m_axi_aximm2_BVALID == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (m_axi_aximm2_AWREADY == 1'b1))) begin
        m_axi_aximm2_AWADDR = sext_ln36_fu_111_p1;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (m_axi_aximm2_AWREADY == 1'b1))) begin
        m_axi_aximm2_AWLEN = zext_ln36_fu_121_p1;
    end else if (((1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state4))) begin
        m_axi_aximm2_AWLEN = grp_Loop_VITIS_LOOP_36_4_proc4_Pipeline_VITIS_LOOP_36_4_fu_75_m_axi_aximm2_AWLEN;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if (((grp_Loop_VITIS_LOOP_36_4_proc4_Pipeline_VITIS_LOOP_36_4_fu_75_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
...
assign icmp_ln36_fu_99_p2 = (($signed(output_size_read_reg_125) > $signed(32'd0)) ? 1'b1 : 1'b0);
...
assign select_ln36_fu_104_p3 = ((icmp_ln36_fu_99_p2[0:0] == 1'b1) ? trunc_ln29_reg_137 : 31'd0);

assign sext_ln36_fu_111_p1 = $signed(trunc_ln_reg_131);

assign trunc_ln29_fu_95_p1 = output_size_dout[30:0];

assign zext_ln36_fu_121_p1 = select_ln36_reg_142;
