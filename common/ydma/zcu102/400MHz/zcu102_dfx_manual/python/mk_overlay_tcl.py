...
for line in file_in:
  if copy_enable:
    ...
    #   file_out.write(line)
      ...
      file_out.write('link_design -mode default -part xczu9eg-ffvb1156-2-e -reconfig_partitions {pfm_top_i/dynamic_region/PR_pages_top_0/inst/page2_inst pfm_top_i/dynamic_region/PR_pages_top_0/inst/page4_inst pfm_top_i/dynamic_region/PR_pages_top_0/inst/page8_inst pfm_top_i/dynamic_region/PR_pages_top_0/inst/page12_inst pfm_top_i/dynamic_region/PR_pages_top_0/inst/page16_inst pfm_top_i/dynamic_region/PR_pages_top_0/inst/page20_inst} -top pfm_top_wrapper\n')
    else:
      file_out.write(line)
