...
reg   [31:0] num_total_cnt_read_reg_127;
reg   [60:0] trunc_ln_reg_132;
wire   [30:0] select_ln32_fu_105_p3;
reg   [30:0] select_ln32_reg_138;
...
wire  signed [63:0] sext_ln32_fu_113_p1;
wire   [31:0] zext_ln32_fu_123_p1;
reg    ap_block_state1;
...
ydma_Loop_VITIS_LOOP_32_2_proc2_Pipeline_VITIS_LOOP_32_2 grp_Loop_VITIS_LOOP_32_2_proc2_Pipeline_VITIS_LOOP_32_2_fu_75(
    ...
    .sext_ln32(trunc_ln_reg_132),
    .num_total_cnt_load(num_total_cnt_read_reg_127),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state72) & (m_axi_aximm1_BVALID == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        num_total_cnt_read_reg_127 <= num_total_cnt_dout;
        select_ln32_reg_138 <= select_ln32_fu_105_p3;
        trunc_ln_reg_132 <= {{output1_dout[63:3]}};
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (m_axi_aximm1_AWREADY == 1'b1))) begin
        m_axi_aximm1_AWADDR = sext_ln32_fu_113_p1;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (m_axi_aximm1_AWREADY == 1'b1))) begin
        m_axi_aximm1_AWLEN = zext_ln32_fu_123_p1;
    end else if (((1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state3))) begin
        m_axi_aximm1_AWLEN = grp_Loop_VITIS_LOOP_32_2_proc2_Pipeline_VITIS_LOOP_32_2_fu_75_m_axi_aximm1_AWLEN;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & (grp_Loop_VITIS_LOOP_32_2_proc2_Pipeline_VITIS_LOOP_32_2_fu_75_ap_done == 1'b1))) begin
...
assign icmp_ln32_fu_85_p2 = (($signed(num_total_cnt_dout) > $signed(32'd0)) ? 1'b1 : 1'b0);
...
assign select_ln32_fu_105_p3 = ((icmp_ln32_fu_85_p2[0:0] == 1'b1) ? trunc_ln29_fu_101_p1 : 31'd0);

assign sext_ln32_fu_113_p1 = $signed(trunc_ln_reg_132);

assign trunc_ln29_fu_101_p1 = num_total_cnt_dout[30:0];

assign zext_ln32_fu_123_p1 = select_ln32_reg_138;
