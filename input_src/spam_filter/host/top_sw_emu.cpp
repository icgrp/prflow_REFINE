  ...
  #pragma HLS INTERFACE ap_hs port=Output_1
    ...
    for(int epoch = 0; epoch<NUM_EPOCHS; epoch++){
      ...
      TRAINING_INST: for( int training_id = 0; training_id < NUM_TRAINING; training_id ++ ){
        dotProduct_1(Output_1_redir, Output_1_1_4_3, Output_1_dot_1, Output_2_dot_1);
        dotProduct_5(Output_2_redir, Output_1_1_4_4, Output_1_dot_5, Output_2_dot_5);

        Sigmoid_axi(Output_1_dot_1, Output_1_dot_5, Output_1_1_4_3, Output_1_1_4_4);
      ...
      if(epoch==4){
        data_2_1(Output_2_dot_1, Output_2_dot_5, Output_1);
      }
    }
 }
