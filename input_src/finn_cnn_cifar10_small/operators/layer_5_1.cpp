...
#define AP_INT_MAX_W_str_dwc_9 36



// defines for network parameters
#define InWidth_str_dwc_9 1 
#define OutWidth_str_dwc_9 36 
#define NumInWords_str_dwc_9 1152 
#define numReps_str_dwc_9 1

void str_dwc_9(hls::stream<ap_uint<1> > &in0, hls::stream<ap_uint<36> > &out)
{
...
#pragma HLS INTERFACE axis register port=Output_1
    ...
    static hls::stream<ap_uint<36>> out_str_dwc_9("out_str_dwc_9");

#pragma HLS dataflow
    str_dwc_9(Input_1, out_str_dwc_9);
    mva_5(out_str_dwc_9, Output_1);
