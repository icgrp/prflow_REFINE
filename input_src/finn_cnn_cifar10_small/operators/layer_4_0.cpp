...
#define AP_INT_MAX_W_str_dwc_7 64



// defines for network parameters
#define InWidth_str_dwc_7 64 
#define OutWidth_str_dwc_7 1 
#define NumInWords_str_dwc_7 25 
#define numReps_str_dwc_7 1

void str_dwc_7(hls::stream<ap_uint<64> > &in0, hls::stream<ap_uint<1> > &out)
{
#pragma HLS INTERFACE axis register port=in0
#pragma HLS INTERFACE axis register port=out
StreamingDataWidthConverter_Batch<InWidth_str_dwc_7, OutWidth_str_dwc_7, NumInWords_str_dwc_7>(in0, out, numReps_str_dwc_7);
}
...
#pragma HLS INTERFACE axis register port=Output_1
    ...
    static hls::stream<ap_uint<1>> out_str_dwc_7("out_str_dwc_7");

#pragma HLS dataflow
    str_dwc_7(Input_1, out_str_dwc_7);
    conv_4(out_str_dwc_7, Output_1);
