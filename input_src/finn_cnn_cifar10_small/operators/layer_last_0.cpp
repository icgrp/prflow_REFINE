...
#define AP_INT_MAX_W_str_dwc_10 4



// defines for network parameters
#define InWidth_str_dwc_10 1 
#define OutWidth_str_dwc_10 4 
#define NumInWords_str_dwc_10 128 
#define numReps_str_dwc_10 1

void str_dwc_10(hls::stream<ap_uint<1> > &in0, hls::stream<ap_uint<4> > &out)
{
...
#pragma HLS INTERFACE axis register port=Output_1
    ...
    static hls::stream<ap_uint<4>> out_str_dwc_10("out_str_dwc_10");

#pragma HLS dataflow
    str_dwc_10(Input_1, out_str_dwc_10);
    mva_6(out_str_dwc_10, Output_1);
