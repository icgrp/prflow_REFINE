...
#define AP_INT_MAX_W_str_dwc_3_1_0 72



// defines for network parameters
#define InWidth_str_dwc_3_1_0 8 
#define OutWidth_str_dwc_3_1_0 72 
#define NumInWords_str_dwc_3_1_0 7200 
#define numReps_str_dwc_3_1_0 1

void str_dwc_3_1_0(hls::stream<ap_uint<8> > &in0, hls::stream<ap_uint<72> > &out)
{
...
#define AP_INT_MAX_W_str_dwc_3_1_1 64



// defines for network parameters
#define InWidth_str_dwc_3_1_1 8 
#define OutWidth_str_dwc_3_1_1 64 
#define NumInWords_str_dwc_3_1_1 800 
#define numReps_str_dwc_3_1_1 1

void str_dwc_3_1_1(hls::stream<ap_uint<8> > &in0, hls::stream<ap_uint<64> > &out)
{
#pragma HLS INTERFACE axis register port=in0
#pragma HLS INTERFACE axis register port=out
...
#pragma HLS INTERFACE axis register port=Output_1
    ...
    static hls::stream<ap_uint<72>> out_str_dwc_3_1_0("out_str_dwc_3_1_0");
    static hls::stream<ap_uint<8>> out_mva_3("out_mva_3");
    static hls::stream<ap_uint<64>> out_str_dwc_3_1_1("out_str_dwc_3_1_1");
