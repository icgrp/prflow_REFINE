...
#pragma HLS INTERFACE axis register port=Output_4
  ...
  Triangle_2D triangle_2ds_3;
  Triangle_2D triangle_2ds_4;
...
#pragma HLS dataflow
    ...
    p_r1_module(data_transfer_out, Output_1, Output_2, Output_3, Output_4);
}
