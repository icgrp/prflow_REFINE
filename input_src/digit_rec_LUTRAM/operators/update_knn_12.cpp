...
#define PAR_FACTOR 120 // should divide 18000 and multiple of 10
#define NUM_OPS 10 // fixed
...
void update_knn_12(hls::stream<ap_uint<32> > & Input_1, hls::stream<ap_uint<32> > & Output_1)
{
...
#pragma HLS bind_storage variable=training_set type=RAM_1P impl=LUTRAM
...
#pragma HLS pipeline
  ...
  TRANSFER_LOOP: for(int i = 0; i < NUM_TRAINING / NUM_OPS * (NUM_OPS - NUM2); i++)
  {
#pragma HLS pipeline
    for(int j=IMAGE_WIDTH-1; j>0; j=j-32){
