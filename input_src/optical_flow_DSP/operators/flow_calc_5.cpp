...
static void tensor_weight_x2(hls::stream< ap_uint<96> > &Input_1,
             hls::stream< ap_uint<96> > &Output_1)
{
// #pragma HLS interface axis register port=Input_1
// #pragma HLS interface axis register port=Output_1
...
static void tensor_weight_x1(hls::stream< ap_uint<96> > &Input_1,
             hls::stream< ap_uint<96> > &Output_1)
{
// #pragma HLS interface axis register port=Input_1
// #pragma HLS interface axis register port=Output_1
...
#pragma HLS interface axis register port=Output_2
    ...
    static hls::stream<ap_uint<96>> out_product1("outer_product1_out_stream");
    static hls::stream<ap_uint<96>> out_product2("outer_product2_out_stream");

    static hls::stream<ap_uint<96>> t_w_y1_out("tensor_weight_y1_out_stream");
    static hls::stream<ap_uint<96>> t_w_y2_out("tensor_weight_y2_out_stream");

    static hls::stream<ap_uint<96>> t_w_x1_out("tensor_weight_x1_out_stream");
    static hls::stream<ap_uint<96>> t_w_x2_out("tensor_weight_x2_out_stream");
