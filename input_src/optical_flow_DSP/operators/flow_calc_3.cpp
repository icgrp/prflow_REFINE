...
// #pragma HLS interface axis register port=Output_1
  OUTER_OUTER: for(int r=0; r<MAX_HEIGHT; r++)
  {
    ...
    OUTER_INNER: for(int c=0; c<MAX_WIDTH; c++)
    {
      ...
      out_tmp(127, 96) = out.val[3].range(31,0);
      out_tmp(159,128) = out.val[4].range(31,0);
      out_tmp(191,160) = out.val[5].range(31,0);
...
#pragma HLS interface axis register port=Output_2
    ...
    static hls::stream<ap_uint<192>> out_product1("outer_product1_out_stream");
    static hls::stream<ap_uint<192>> t_w_y1_out("tensor_weight_y1_out_stream");
    static hls::stream<ap_uint<192>> t_w_x1_out("tensor_weight_x1_out_stream");

#pragma HLS dataflow
    outer_product(Input_1, Input_2, Input_3, out_product1);
    tensor_weight_y_1(out_product1,t_w_y1_out);
    tensor_weight_x_1(t_w_y1_out,t_w_x1_out);
