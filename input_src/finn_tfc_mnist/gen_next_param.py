...
def gen_data_transfer_func():
    ...
    func_str_list.append('')
    func_str_list.append('    // INPUT_SIZE = 7840')
    func_str_list.append('    for ( int i = 0; i < 7840; i++){')
    func_str_list.append('        in_tmp = Input_1.read();')
    func_str_list.append('        for (int j = 0; j < 8; j++){ // 8 = 512/64')
    func_str_list.append('            out_tmp = in_tmp(64*j+63, 64*j+0);')
...
# layer_0_0:    thr_batch - str_dwc - mva 
def gen_layer_0_0(src_dir, count_str_dwc, layer_num, layer_index):
    ...
    if thr_batch_out != mva_in:
        layer_filedata.append('    static hls::stream<ap_uint<' + str(mva_in) + '>> out_str_dwc_0("out_str_dwc_0");\n')
    ...
    if thr_batch_out != mva_in:
        ...
        layer_filedata.append('    mva_' + str(layer_num) + '(out_str_dwc_0, Output_1);\n')
    else:
        layer_filedata.append('    mva_' + str(layer_num) + '(out_thr_batch, Output_1);\n')
    layer_filedata.append('\n')
    layer_filedata.append('}\n')
    ...
    return count_str_dwc, mva_out, 'layer_' + str(layer_num) + '_' + str(layer_index), "".join(new_filedata), "".join(layer_h_filedata)
...
def gen_layer_mva(src_dir, count_str_dwc, prev_out_width, layer_num, layer_index, layer_name):
    ...
    return count_str_dwc, mva_out,  'layer_' + str(layer_name) + '_' + str(layer_index),  "".join(new_filedata), "".join(layer_h_filedata)
...
def gen_layer_conv(src_dir, count_str_dwc, prev_out_width, layer_num, layer_index):
    ...
    return count_str_dwc, conv_out, 'layer_' + str(layer_num) + '_' + str(layer_index),  "".join(new_filedata), "".join(layer_h_filedata)
...
def gen_layer_mva_mp(src_dir, count_str_dwc, prev_out_width, layer_num, layer_index, mp_index, layer_name):
    ...
    return count_str_dwc, str_mp_batch_out, 'layer_' + str(layer_name) + '_' + str(layer_index),  "".join(new_filedata), "".join(layer_h_filedata)



# # layer_last:             str_dwc - mva - str_dwc - lab_sel
...
#     prev_out_width_0 = prev_out_width
#     print(prev_out_width_0)
...
#         layer_filedata_top.append('    static hls::stream<ap_uint<' + str(mva_0_in) + '>> out_str_dwc_' + str(count_str_dwc) +\
#                                  '("out_str_dwc_' + str(count_str_dwc) + '");\n')
#     layer_filedata_top.append('    static hls::stream<ap_uint<' + str(mva_0_out) + '>> out_mva_' + str(layer_num) +\
#                                 '("out_mva_' + str(layer_num) + '");\n')
...
#         new_filedata.append('// ------------------------------------------------------------------------\n')
#         new_filedata.append('\n')
#     prev_out_width = mva_0_out


#     # str - label_sel
#     if prev_out_width != 8:
#         layer_filedata_top.append('    static hls::stream<ap_uint<8>> out_str_dwc_' + str(count_str_dwc) +\
#                                  '("out_str_dwc_' + str(count_str_dwc) + '");\n')
#     layer_filedata_top.append('\n')
#     layer_filedata_top.append('#pragma HLS dataflow\n')


#     if prev_out_width != 8:
#         layer_filedata.append('    str_dwc_' + str(count_str_dwc) + '(out_mva_' + str(layer_num) + ', out_str_dwc_' + str(count_str_dwc) + ');\n')
#         layer_filedata.append('    lab_sel_0(out_str_dwc_' + str(count_str_dwc) + ', Output_1);\n')
...
#         count_str_dwc = count_str_dwc + 1
#     else:
#         layer_filedata.append('    lab_sel_0(out_mva_' + str(layer_num) + ', Output_1);\n')
#     layer_filedata.append('\n')
#     layer_filedata.append('}\n')
...
#     new_filedata = new_filedata_include + new_filedata + layer_filedata_top + layer_filedata
...
#         '\n',
#         'void layer_' + str(layer_name) + '_' + str(layer_index) + ' (\n',
#         '        hls::stream<ap_uint<' + str(prev_out_width_0) + '>> & Input_1,\n',
#         '        hls::stream<ap_uint<8>> & Output_1\n', # fixed to 8
#         '        );\n',
#         '#pragma map_target = HW\n']
#     # with open(src_dir + 'layer_' + str(layer_name) + '_' + str(layer_index) +'.h' , 'w') as outfile:
...
#     return count_str_dwc, 8, 'layer_' + str(layer_name) + '_' + str(layer_index),  "".join(new_filedata), "".join(layer_h_filedata)


# layer_last:             str_dwc - lab_sel
def gen_layer_last(src_dir, count_str_dwc, prev_out_width, layer_num, layer_index, layer_name):
    ...
    if prev_out_width != 8:
        ...
        layer_filedata.append('    lab_sel_0(Input_1, Output_1);\n')
    layer_filedata.append('\n')
    layer_filedata.append('}\n')
...
if __name__ == '__main__':
    ...
    count_str_dwc, prev_out_width, func_name, filedata, filedata_header = gen_layer_mva(src_dir, count_str_dwc, prev_out_width, layer_num, layer_index, '1')
    func_name_list.append(func_name)
    filedata_dict[func_name] = (filedata, filedata_header)
    if needs_write_param(func_name, filedata):
        ops_to_compile_list.append(func_name)
    ...
    count_str_dwc, prev_out_width, func_name, filedata, filedata_header = gen_layer_mva(src_dir, count_str_dwc, prev_out_width, layer_num, layer_index, '3')
    func_name_list.append(func_name)
    filedata_dict[func_name] = (filedata, filedata_header)
    if needs_write_param(func_name, filedata):
        ops_to_compile_list.append(func_name)
    ...
    top_str_list = ['data_transfer(Input_1, data_transfer_OUT_1);',
                    'layer_0_0(data_transfer_OUT_1, layer_0_0_OUT_1);',
                    'layer_1_0(layer_0_0_OUT_1, layer_1_0_OUT_1);',
                    'layer_2_0(layer_1_0_OUT_1, layer_2_0_OUT_1);',
                    'layer_3_0(layer_2_0_OUT_1, layer_3_0_OUT_1);',
                    'layer_4_0(layer_3_0_OUT_1, layer_4_0_OUT_1);',
                    'layer_last_0(layer_4_0_OUT_1, layer_last_0_OUT_1);',
                    'out_data_collect(layer_last_0_OUT_1, Output_1);']
