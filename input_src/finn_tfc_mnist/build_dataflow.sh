...
export FINN_HOST_BUILD_DIR=${PRJ_DIR}/input_src/finn_tfc_mnist/_finn_gen_dir/build_dir
# rm previously generated build_dir
rm -rf $FINN_HOST_BUILD_DIR
rm -rf ./_finn_gen_dir/*.cpp
rm -rf ./_finn_gen_dir/*.h
...
cp ./_finn_gen_dir/finn_tfc_gen.py $FINN_V22_DIR
cd $FINN_V22_DIR
bash ./run-docker.sh python finn_tfc_gen.py

# cd back to prflow dir
cd ${PRJ_DIR}/input_src/finn_tfc_mnist/
