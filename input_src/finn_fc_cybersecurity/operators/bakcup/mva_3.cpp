...
void mva_3(
                    hls::stream<ap_uint<2>> &in0,
                    hls::stream<ap_uint<2>> &weights,
...
Matrix_Vector_Activate_Stream_Batch<MW1, MH1, SIMD1, PE1, Slice<ap_uint<2>>, Slice<ap_int<1>>, Identity, ap_int<2> >
