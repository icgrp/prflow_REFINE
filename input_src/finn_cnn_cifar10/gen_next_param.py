...
def gen_layer_0_0(src_dir, count_str_dwc, layer_num, layer_index):
    ...
    return count_str_dwc, conv_out, 'layer_' + str(layer_num) + '_' + str(layer_index), new_filedata, layer_h_filedata
...
def gen_layer_mva(src_dir, count_str_dwc, prev_out_width, layer_num, layer_index, layer_name):
    ...
    return count_str_dwc, mva_out,  'layer_' + str(layer_name) + '_' + str(layer_index), new_filedata, layer_h_filedata
...
def gen_layer_mva_mp(src_dir, count_str_dwc, prev_out_width, layer_num, layer_index, mp_index, layer_name):
    ...
    return count_str_dwc, str_mp_batch_out, 'layer_' + str(layer_name) + '_' + str(layer_index), new_filedata, layer_h_filedata
...
def gen_layer_last(src_dir, count_str_dwc, prev_out_width, layer_num, layer_index, layer_name):
    ...
    return count_str_dwc, 8, 'layer_' + str(layer_name) + '_' + str(layer_index), new_filedata, layer_h_filedata
