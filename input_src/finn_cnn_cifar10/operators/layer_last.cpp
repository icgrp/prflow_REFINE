...
#pragma HLS ARRAY_PARTITION variable=mva_6_thresh.m_thresholds complete dim=1
#pragma HLS ARRAY_PARTITION variable=mva_6_thresh.m_thresholds complete dim=3
Matrix_Vector_Activate_Batch<MW1_mva_6, MH1_mva_6, SIMD1_mva_6, PE1_mva_6, 1, Recast<XnorMul>, Slice<ap_uint<1>>, Identity>
                (in0, out, mva_6_weights, mva_6_thresh, numReps_mva_6, ap_resource_lut());
}
...
#pragma HLS INTERFACE axis register port=Output_1
    ...
    static hls::stream<ap_uint<16>> out_str_dwc_13("out_str_dwc_13");
    static hls::stream<ap_uint<1>> out_mva_6("out_mva_6");
    static hls::stream<ap_uint<32>> out_str_dwc_14("out_str_dwc_14");
    static hls::stream<ap_uint<1>> out_mva_7("out_mva_7");
    static hls::stream<ap_uint<16>> out_mva_8("out_mva_8");

#pragma HLS dataflow
    str_dwc_13(Input_1, out_str_dwc_13);
    mva_6(out_str_dwc_13, out_mva_6);
    str_dwc_14(out_mva_6, out_str_dwc_14);
    mva_7(out_str_dwc_14, out_mva_7);
    mva_8(out_mva_7, out_mva_8);
