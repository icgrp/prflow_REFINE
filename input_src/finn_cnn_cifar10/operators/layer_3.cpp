...
hls::stream<ap_uint<144>> intermediate_str_dwc_7 ("intermediate_str_dwc_7");
StreamingDataWidthConverter_Batch<InWidth_str_dwc_7, LCMWidth_str_dwc_7, NumInWords_str_dwc_7>(in0, intermediate_str_dwc_7, numReps_str_dwc_7);
StreamingDataWidthConverter_Batch<LCMWidth_str_dwc_7, OutWidth_str_dwc_7, NumLCMToOut_str_dwc_7>(intermediate_str_dwc_7, out, numReps_str_dwc_7);
}
...
#pragma HLS ARRAY_PARTITION variable=mva_3_thresh.m_thresholds complete dim=1
#pragma HLS ARRAY_PARTITION variable=mva_3_thresh.m_thresholds complete dim=3
Matrix_Vector_Activate_Batch<MW1_mva_3, MH1_mva_3, SIMD1_mva_3, PE1_mva_3, 1, Recast<XnorMul>, Slice<ap_uint<1>>, Identity>
                (in0, out, mva_3_weights, mva_3_thresh, numReps_mva_3, ap_resource_lut());
}
...
#pragma HLS INTERFACE axis register port=Output_1
    ...
    static hls::stream<ap_uint<16>> out_str_dwc_6("out_str_dwc_6");
    static hls::stream<ap_uint<16>> out_conv_3("out_conv_3");
    static hls::stream<ap_uint<72>> out_str_dwc_7("out_str_dwc_7");
    static hls::stream<ap_uint<32>> out_mva_3("out_mva_3");
    static hls::stream<ap_uint<128>> out_str_dwc_8("out_str_dwc_8");

#pragma HLS dataflow
    str_dwc_6(Input_1, out_str_dwc_6);
    conv_3(out_str_dwc_6, out_conv_3);
    str_dwc_7(out_conv_3, out_str_dwc_7);
    mva_3(out_str_dwc_7, out_mva_3);
    str_dwc_8(out_mva_3, out_str_dwc_8);
    str_mp_batch_1(out_str_dwc_8, Output_1);
