...
hls::stream<ap_uint<144>> intermediate_str_dwc_5 ("intermediate_str_dwc_5");
StreamingDataWidthConverter_Batch<InWidth_str_dwc_5, LCMWidth_str_dwc_5, NumInWords_str_dwc_5>(in0, intermediate_str_dwc_5, numReps_str_dwc_5);
StreamingDataWidthConverter_Batch<LCMWidth_str_dwc_5, OutWidth_str_dwc_5, NumLCMToOut_str_dwc_5>(intermediate_str_dwc_5, out, numReps_str_dwc_5);
}
...
#pragma HLS ARRAY_PARTITION variable=mva_2_thresh.m_thresholds complete dim=1
#pragma HLS ARRAY_PARTITION variable=mva_2_thresh.m_thresholds complete dim=3
Matrix_Vector_Activate_Batch<MW1_mva_2, MH1_mva_2, SIMD1_mva_2, PE1_mva_2, 1, Recast<XnorMul>, Slice<ap_uint<1>>, Identity>
                (in0, out, mva_2_weights, mva_2_thresh, numReps_mva_2, ap_resource_lut());
}
...
#pragma HLS INTERFACE axis register port=Output_1
    ...
    static hls::stream<ap_uint<16>> out_str_dwc_4("out_str_dwc_4");
    static hls::stream<ap_uint<16>> out_conv_2("out_conv_2");
    static hls::stream<ap_uint<72>> out_str_dwc_5("out_str_dwc_5");

#pragma HLS dataflow
    str_dwc_4(Input_1, out_str_dwc_4);
    conv_2(out_str_dwc_4, out_conv_2);
    str_dwc_5(out_conv_2, out_str_dwc_5);
    mva_2(out_str_dwc_5, Output_1);
}
