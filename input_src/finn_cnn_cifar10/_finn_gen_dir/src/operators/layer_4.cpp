...
#pragma HLS INTERFACE axis register port=Output_1
    ...
    static hls::stream<ap_uint<2>> out_str_dwc_0("out_str_dwc_0");
    static hls::stream<ap_uint<2>> out_conv("out_conv");
    static hls::stream<ap_uint<72>> out_str_dwc_1("out_str_dwc_1");

#pragma HLS dataflow
    str_dwc_9(Input_1, out_str_dwc_0);
    conv_4(out_str_dwc_0, out_conv);
    str_dwc_10(out_conv, out_str_dwc_1);
    mva_4(out_str_dwc_1, Output_1);
