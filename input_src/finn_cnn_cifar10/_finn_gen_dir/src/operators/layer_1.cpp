...
#pragma HLS INTERFACE axis register port=Output_1
    ...
    static hls::stream<ap_uint<64>> out_str_dwc_0("out_str_dwc_0");
    static hls::stream<ap_uint<64>> out_conv("out_conv");
    static hls::stream<ap_uint<72>> out_str_dwc_1("out_str_dwc_1");
    static hls::stream<ap_uint<64>> out_mva("out_mva");

#pragma HLS dataflow
    str_dwc_2(Input_1, out_str_dwc_0);
    conv_1(out_str_dwc_0, out_conv);
    str_dwc_3(out_conv, out_str_dwc_1);
    mva_1(out_str_dwc_1, out_mva);
    str_mp_batch_0(out_mva, Output_1);
