...
#pragma HLS INTERFACE axis register port=Output_1
    ...
    static hls::stream<ap_uint<1>> out_str_dwc_0("out_str_dwc_0");
    static hls::stream<ap_uint<1>> out_conv("out_conv");
    static hls::stream<ap_uint<72>> out_str_dwc_1("out_str_dwc_1");

#pragma HLS dataflow
    str_dwc_11(Input_1, out_str_dwc_0);
    conv_5(out_str_dwc_0, out_conv);
    str_dwc_12(out_conv, out_str_dwc_1);
    mva_5(out_str_dwc_1, Output_1);
