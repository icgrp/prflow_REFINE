...
#define AP_INT_MAX_W_str_dwc_6_0_0 8



// defines for network parameters
#define InWidth_str_dwc_6_0_0 2 
#define OutWidth_str_dwc_6_0_0 8 
#define NumInWords_str_dwc_6_0_0 128 
#define numReps_str_dwc_6_0_0 1

void str_dwc_6_0_0(hls::stream<ap_uint<2> > &in0, hls::stream<ap_uint<8> > &out)
{
...
void mva_6(hls::stream<ap_uint<8>> &in0,
...
Matrix_Vector_Activate_Batch<MW1_mva_6, MH1_mva_6, SIMD1_mva_6, PE1_mva_6, 1, Slice<ap_int<2>>, Slice<ap_int<2>>, Recast<Binary>>
...
#pragma HLS INTERFACE axis register port=Output_1
    ...
    static hls::stream<ap_uint<8>> out_str_dwc_6_0_0("out_str_dwc_6_0_0");
